...
const BlackKingIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g fill="#000" stroke="#FFF" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
            ...
            <path d="M11.5 38.5a25 25 0 0 0 22 0" fill="none"/>
            <path d="M11.5 29.5a25 25 0 0 1 22 0" fill="none"/>
            <path d="M11.5 32.5a25 25 0 0 1 22 0" fill="none"/>
            <path d="M11.5 35.5a25 25 0 0 1 22 0" fill="none"/>
