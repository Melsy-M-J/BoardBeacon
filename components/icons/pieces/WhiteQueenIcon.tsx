...
const WhiteQueenIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g fill="#FFF" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
            ...
            <path d="M9 26c0 2 1.5 4 1.5 4 5 3.5 18 3.5 23 0 0 0 1.5-2 1.5-4" fill="none" stroke="#000"/>
            <path d="M11.5 30c5.5 3.5 16.5 3.5 22 0" fill="none" stroke="#000"/>
            <path d="M11.5 33c5.5 3.5 16.5 3.5 22 0" fill="none" stroke="#000"/>
            <path d="M12.5 36c5.5 3.5 14.5 3.5 20 0" fill="none" stroke="#000"/>
        </g>
    </svg>
);
